  ...
  return (
    <SafeAreaView className="flex-1 bg-background">
      ...
      <View className="p-4 border-b border-gray-200 flex-row items-center justify-between">
        ...
        <Text className="text-xl font-bold text-gray-800">Create Itinerary</Text>
      ...
      <ScrollView className="flex-1 p-6">
        ...
        <View className="mb-6">
          ...
          <View className="flex-row mb-4">
            ...
            <View className="flex-1 ml-2">
              <Text className="text-gray-700 mb-2 font-medium">Price (USD)</Text>
              <TextInput
                className="bg-white p-4 rounded-lg border border-gray-300"
        ...
        {/* Itinerary Details */}
        <View className="mb-6">
          <Text className="text-lg font-bold text-gray-800 mb-4">Itinerary Details</Text>

          {[1, 2, 3].map((day) => (
            <View key={day} className="bg-white p-4 rounded-lg border border-gray-300 mb-3">
        ...
        <View className="mb-6">
          ...
          {["Accommodation", "Meals", "Guide"].map((item, index) => (
            <View key={index} className="flex-row items-center bg-white p-4 rounded-lg border border-gray-300 mb-3">
              <Ionicons name="checkmark-circle" size={20} color="#10b981" />
              <TextInput className="flex-1 ml-2" placeholder="e.g. Accommodation" defaultValue={item} />
              <TouchableOpacity>
        ...
        {/* Map Location */}
        <View className="mb-8">
          <Text className="text-lg font-bold text-gray-800 mb-4">Map Location</Text>
          <TouchableOpacity className="bg-white p-4 rounded-lg border border-gray-300 items-center justify-center h-40">
            ...
            <Text className="mt-2 text-gray-600">Set Location on Map</Text>
          </TouchableOpacity>
        </View>
      </ScrollView>
      ...
      <View className="p-4 bg-white border-t border-gray-200">
        <TouchableOpacity className="bg-primary p-4 rounded-lg items-center" onPress={handleSave}>
